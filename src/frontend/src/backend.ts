...
export class Backend implements backendInterface {
    ...
    async getVoiceSubmissions(): Promise<Array<VoiceSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVoiceSubmissions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async storeContactSubmission(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.storeContactSubmission(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async storeVoiceSubmission(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.storeVoiceSubmission(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
